...
// see the issue is when we are triggering the route /api/register ye immediately vaha per user bna de rha hi is vajah se issue a rha hai 
// solution ke liye backend set krna padega route and all taki taabhi enter ho jab verify ho 

// btate hai tab tak feed vala issue solve karo har page ke liye 
//ok